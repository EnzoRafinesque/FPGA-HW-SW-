namespace eval ::optrace {
  variable script "/home/mdu/Desktop/first_proj/xilinx_zc706_base/vitis/matmul_system_hw_link/Hardware/binary_container_1.build/link/vivado/vpl/vpl.tcl"
...
set rc [catch {
  ...
  if {$enable_multi_strategies} {
    ...
    foreach strategy $run_strategies {
      ...
      if { [get_run $st_run_name] ne "" } {
        set _run [get_run $st_run_name]
