...
set kernel_ip_dirs [list \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_hls_matmul_1_0"]
set install_ip_cache "/tools/Xilinx/Vitis/2021.2/data/cache/xilinx"
...
lappend bus_sp_tags HP0_DDR_LOWOCM HP0
lappend bus_sp_indeces HP0_DDR_LOWOCM 0
lappend bus_slrs HP0_DDR_LOWOCM SLR0
lappend bus_sp_tags HP1_DDR_LOWOCM HP1
lappend bus_sp_indeces HP1_DDR_LOWOCM 0
lappend bus_slrs HP1_DDR_LOWOCM SLR0
lappend bus_sp_tags HP2_DDR_LOWOCM HP2
lappend bus_sp_indeces HP2_DDR_LOWOCM 0
lappend bus_slrs HP2_DDR_LOWOCM SLR0
lappend bus_sp_tags HP3_DDR_LOWOCM HP3
lappend bus_sp_indeces HP3_DDR_LOWOCM 0
lappend bus_slrs HP3_DDR_LOWOCM SLR0

set hw_platform_info [dict create \
  hw_platform_dir              ".local/hw_platform" \
  hw_platform_file             "/tools/Xilinx/Vitis/2021.2/platforms/xilinx_zc706_base_202120_1/hw/hw.xsa" \
  hw_platform_part             "xc7z045ffg900-2" \
  hw_platform_vbnv             "xilinx.com:xd:xilinx_zc706_base_202120_1:202120.1" \
  bb_locked_dcp                "" \
  bb_synth_dcp                 "" \
  ...
  dr_bd_name                   "xilinx_zc706_base.bd" \
  top_module_name              "xilinx_zc706_base_wrapper" \
  ...
  hw_platform_board_part       "xilinx.com:zc706:part0:1.4" \
  link_output_format           "bitstream" \
  xpfm_file                    "/tools/Xilinx/Vitis/2021.2/platforms/xilinx_zc706_base_202120_1/xilinx_zc706_base_202120_1.xpfm" \
