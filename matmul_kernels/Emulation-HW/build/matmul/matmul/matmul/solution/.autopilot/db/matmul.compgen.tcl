...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matmul_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matmul_gmem0_m_axi BINDTYPE interface TYPE interface_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matmul_gmem1_m_axi BINDTYPE interface TYPE interface_m_axi
}
