...
set C_modelArgList {
	...
	{ sext_ln90 int 27 regular  }
	{ C_V int 16 regular {array 256 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln90", "interface" : "wire", "bitwidth" : 27, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln90 sc_in sc_lv 27 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln90", "direction": "in", "datatype": "sc_lv", "bitwidth":27, "type": "signal", "bundle":{"name": "sext_ln90", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln90 { ap_none {  { sext_ln90 in_data 0 27 } } }
