...
wire    ap_loop_init;
reg   [8:0] j_fu_68;
wire   [8:0] j_4_fu_257_p2;
reg   [31:0] i_fu_72;
wire   [31:0] i_2_fu_211_p3;
reg   [8:0] itr_1_fu_76;
wire   [8:0] add_ln45_fu_146_p2;
reg   [8:0] ap_sig_allocacmp_itr;
wire   [4:0] empty_28_fu_152_p1;
wire   [0:0] icmp_ln47_fu_187_p2;
wire   [8:0] j_3_fu_199_p3;
wire   [31:0] add_ln49_fu_193_p2;
wire   [3:0] trunc_ln51_fu_219_p1;
wire   [7:0] tmp_3_cast_fu_223_p3;
wire   [7:0] trunc_ln47_fu_207_p1;
wire   [7:0] add_ln51_fu_231_p2;
reg    ap_done_reg;
...
assign add_ln45_fu_146_p2 = (ap_sig_allocacmp_itr + 9'd1);
...
assign icmp_ln45_fu_140_p2 = ((ap_sig_allocacmp_itr == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln47_fu_187_p2 = ((j_fu_68 == 9'd16) ? 1'b1 : 1'b0);

assign icmp_ln51_fu_156_p2 = ((empty_28_fu_152_p1 == 5'd0) ? 1'b1 : 1'b0);

assign j_3_fu_199_p3 = ((icmp_ln47_fu_187_p2[0:0] == 1'b1) ? 9'd0 : j_fu_68);

assign j_4_fu_257_p2 = (j_3_fu_199_p3 + 9'd1);
...
assign tmp_3_cast_fu_223_p3 = {{trunc_ln51_fu_219_p1}, {4'd0}};

assign trunc_ln47_fu_207_p1 = j_3_fu_199_p3[7:0];

assign trunc_ln51_fu_219_p1 = i_2_fu_211_p3[3:0];
